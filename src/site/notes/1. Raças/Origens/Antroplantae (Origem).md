---
{"dg-publish":true,"permalink":"/1-racas/origens/antroplantae-origem/","tags":["origem"],"dg-note-properties":{"tags":["origem"]}}
---


![center](https://wiki.runarcana.org/images/d/db/Origens-antroplantae-zyra.png)
## Antroplantae
...
### Traços de Origem dos Antroplantae
...
**Região**: Você recebe uma **Herança de Região (Vantagem)** e um **idioma** dessa região. Você deve escolher sua Região que definirá onde você cresceu e muito de como você vê o mundo.

**Idioma**: Antroplantæ podem falar Silvestre. Eles podem se comunicar com qualquer árvore de seu próprio tipo como se usassem a magia falar com plantas.

**Linhagens**: Você deve escolher um entre as Estirpes a seguir:
- **Estirpes**
	- [[1. Raças/Linhagens/Antroplantae (Linhagens)#— Arbóreo\|Arbóreo]]
	- [[1. Raças/Linhagens/Antroplantae (Linhagens)#— Floral\|Floral]]
...
- **RESISTÊNCIA**: Esta vantagem confere pele endurecida, escamas ou tecido muscular extremamente denso que aumenta sua Resistência em +1.
    
- **Durante a Criação**, escolha entre "**Tamanho +1**", "**Tamanho -1**" ou mantenha o tamanho padrão 0 (Não poderá mudar depois).

#### Habilidades Negativas:
- **DEPENDÊNCIA:** Antroplantæ não tem necessidade de se alimentar, mas devem passar pelo menos 4 horas do dia no sol e tomar 5 litros de água por dia. Se não tiver o contato necessário, recebem automaticamente um nível de Fadiga por dia até ficar Incapacitado. No dia seguinte à Incapacitação, morrem. Cada hora gasta se recuperando na substância apropriada restaura um nível de Fadiga.
    
- **FRAQUEZA ELEMENTAL:** A raça sofre uma penalidade de -4 para resistir a um efeito Elemental tipo fogo. Se o ser sofre um ataque baseado nessa forma, a penalidade age como um bônus de dano.
