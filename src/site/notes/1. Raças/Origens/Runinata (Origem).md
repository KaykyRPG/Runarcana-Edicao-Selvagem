---
{"dg-publish":true,"permalink":"/1-racas/origens/runinata-origem/","tags":["origem"],"dg-note-properties":{"tags":["origem"]}}
---


![center](https://wiki.runarcana.org/images/9/94/Runinata_-_Briar.png)
## Runinata
...
[[1. Raças/Origens/Runinata (Origem)#Galeria de Traços (Revisar)\|#Galeria de Traços (Revisar)]]

#### Traços Positivas: 
- ...

#### Traços Negativas: 
- **Forasteiro (Maior)**: Runinatas não são uma raça comum, exatamente por serem criados por meios mutagênicos não naturais. Por isso todas as civilizações que não possuem muito ou nenhum contato com Runinatas, os tratam como aberrações, tendo medo, desprezo e discriminação contra eles. Também subtraem **-4 de rolagens de Persuadir** quando lidam com outra espécie além de sua própria.
