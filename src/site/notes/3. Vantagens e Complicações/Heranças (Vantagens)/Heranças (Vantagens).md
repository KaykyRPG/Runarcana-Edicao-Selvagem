---
{"dg-publish":true,"permalink":"/3-vantagens-e-complicacoes/herancas-vantagens/herancas-vantagens/","tags":["vantagem","herança"],"dg-note-properties":{"tags":["vantagem","herança"]}}
---


![Heranças-Runarcana.png](/img/user/10.%20Infraestrutura/z_Assets/Images/Runarcana%20-%20Images/Heran%C3%A7as-Runarcana.png)

## Abastado
## Acólito Arcanista
## Acordes de Poder
## Adaptação Selvagem
> [!attention] *Pré-requisito: Troll*
...
## Castelo de Areia
## Cauda Preênsil
> [!attention] *Pré-requisito: Shimon, Oovi'kat ou Meio Vastaya Shimon ou Oovi'kat* 
...
## Forma de Sho’Ma
## Forma Dracônica 
> [!attention] *Pré-requisito: Estágio: Veterano, Meio-Dragão* 

**(NÃO ESTÁ ADAPTADO)**
o Meio-Dragão conhece mais sua própria natureza, aprendendo a assumir sua Forma de Dragão, podendo assim se transformar um número de vezes igual a metade do seu bônus de proficiência por descanso pleno. Essa forma dura por até 3 horas ou até você se destransformar usando uma ação bônus. Ao se transformar você recebe as seguintes características:

- Seus atributos físicos são substituídos pelo Elemental de sua essência descritos no final dessa origem. Caso você possua um atributo físico que seja superior ao de sua forma dracônica, você mantém o maior valor.
    
- Você pode realizar as Ações de sua forma de acordo com o Elemental de sua essência descritos no final dessa origem.
    
- Quando você se transforma, você mantém os seus pontos de vida e dados de vida. Caso caia a 0 pontos de vida você terá de fazer salvaguarda contra a morte como normalmente faria, morrer em forma de Dragão significa morte de seu personagem.
    
- Você pode conjurar magias nessa forma, exceto magias que consumam componente material.
...
## Mestre Tático
## Minucioso
> [!attention] *Pré-Requisito: Piltovense* 
...
## Modularidade
## Mordida Infecciosa
> [!attention] *Pré-requisito: Troll do Gelo*
...
**Efeito:**
Sua mordida causa **+1d4 de dano venenoso adicional**. O bônus do dado de dano escala conforme o Estágio:

| **Estágios:**  | Melhorias por Estágio abaixo:  |
| -------------- | ------------------------------ |
| **Experiente** | O ataque aumenta em +1.        |
| **Veterano**   | O dano venenoso aumenta em +1. |
| **Heroico**    | O dano venoso se torna 1d6.    |

## Musicista Prodígio
## Nascido em Kumungu
## Neófito Shugenja
## Núcleo Dividido
> [!attention] *Pré-requisito: Runinata com Consistência Gelatinosa* 

Você possui um núcleo dentro de si que é capaz de se dividir em várias partes. Você recebe os seguintes benefícios:

- Ao ser reduzido a receber o máximo de ferimentos, você se **divide em 4 pedaços** que tentam se recombinar. Cada pedaço é lançado a 3 quadros (6m) de você em direções opostas, no início de cada um de seus turnos os pedaços se movem 1 quadro em direção a onde você estava. Cada pedaço possui o máximo de 1 ferimento que pode receber, resistência sendo a mesma, tendo todas as suas resistências e imunidades, mas inimigos tem **+2 de bônus em ataque contra você**. Quando cada pedaço retornar ao espaço que você ocupava, você retorna a sua forma normal com um ferimento a menos do seu máximo. Essa habilidade se ativa uma vez por descanso completo.
...
## Perceber Fraquezas
## Perceptivo
> [!attention] *Pré-requisito: Vastaya ou Humano* 
...
- Você recebe bônus de **+1 em Perícia Perceber**.
- Ao realizar um teste de Perceber, você pode optar por **fazer novamente a jogada**, aceitando o novo resultado. Você pode realizar isso uma vez por descanso completo.
- Você tem **visão às cegas** com um alcance de 2 quadros (4m). Dentro desse alcance, você pode ver com eficácia qualquer coisa que não esteja atrás de uma cobertura total, mesmo se estiver Cego ou em escuridão. Além disso, você pode perceber **criaturas Invisíveis** dentro desse alcance, a menos que a criatura esteja furtiva.
...
## Pteropus
## Quebra Gelo
> [!attention] *Pré-requisito: Freljordiano*
...
## Valor da Justiceira
## Variante Anfíbio
## [Variante Colosso](https://wiki.runarcana.org/Heran%C3%A7as_Variantes#Colosso "Heranças Variantes")
## [Variante Glacinata](https://wiki.runarcana.org/Heran%C3%A7as_Variantes#Glacinata "Heranças Variantes")
## [Variante Meio-Vastaya](https://wiki.runarcana.org/Heran%C3%A7as_Variantes#Meio-Vastaya "Heranças Variantes")
## [Variante Progressão Tecnológica](https://wiki.runarcana.org/Heran%C3%A7as_Variantes#Progress%C3%A3o_Tecnol%C3%B3gica "Heranças Variantes")
## [Variante Ressurgido](https://wiki.runarcana.org/Heran%C3%A7as_Variantes#Ressurgido "Heranças Variantes")
## Viajante Cauteloso
## Vida Marinha
## Vida Nômade
## Visão Lunar
