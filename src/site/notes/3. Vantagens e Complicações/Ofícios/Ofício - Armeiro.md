---
{"dg-publish":true,"permalink":"/3-vantagens-e-complicacoes/oficios/oficio-armeiro/","tags":["vantagem","ofício"],"dg-note-properties":{"tags":["vantagem","ofício"]}}
---
...
**Atributo**: *o Atributo para testes ligados ao Ofício de Armeiro é Astúcia*
...
Para reparar uma arma que tenha sofrido algum dano em sua integridade é necessária uma jogada de perícia do **Ofício Armeiro**. Em alguns casos, é necessário além da jogada, o **Conjunto de Armeiro** e **Peças de Armas**.
...
Desemperrar uma arma de fogo requer no mínimo uma ação. A criatura com arma deve fazer uma rolagem de perícia do Ofício de Armeiro com Penalidade definida pelo mestre dependendo da situação. Em um sucesso a arma é desemperrada e pode ser usada normalmente, em uma falha, a arma continua emperrada e em uma falha crítica a arma fica inutilizada.

#### • Desemperrar Arma de Fogo Fora de Combate:
Desemperrar uma arma de fogo fora de combate pode ser feito em 10 minutos para armas leves e 20 minutos para armas pesadas.
...
#### • Reparando
Não pode ser feita durante um combate, requer 5 minutos para armas leves e 10 para armas pesadas. Em uma falha, ela continua inutilizada, em uma falha crítica ela é quebrada.
...
Para consertar uma arma de fogo o tempo varia de acordo com o dano causado, é necessário o gasto de tempo e peças para substituição (definido pelo mestre). Durante a jogada de Ofício, um sucesso significa que a arma foi consertada e pode ser usada normalmente, em uma falha ela continua quebrada e em uma falha crítica é destruída.
...
O armeiro deve fazer uma jogada de ofício com Penalidade (definida pelo mestre), em um sucesso ele consegue recuperar algumas partes da arma no valor de 10% da mesma *(arredondado para baixo)*, em uma falha as peças são perdidas e em uma falha crítica, o armeiro recebe 1d4 de dano.

# Fórmulas do Ofício

## Armeiro Aprendiz (Nível 1)
> [!attention]- *Requisitos: Estágio: Novato*
...
Você aumenta a Capacidade de Munição da arma em +1, até o máximo permitido para cada tipo de arma.
...
***Acerto com Ampliação***. Obras-primas Gerais
...
- **Novato**: *Pistola, Carabina, Arcabuz, Canhão de Mão* `(25 Peças de Arma e 0 Penalidade)`

- **Experiente**: *Garrucha (Pistola), Derringer (Pistola), Espingarda (Carabina), Mosquete (Arcabuz) Canhão Médio (Canhão de Mão), Lança-granadas Simples, (Canhão de Mão), Lança-Chamas Simples* `(50 Peças de Arma e 0 Penalidade)`

- **Veterano**: *Revolver (Garrucha), Escopeta (Espingarda), Rifle (Mosquete), Canhão Pesado (Canhão Médio), Lança-Granadas Médio (Lança-granadas Simples)* `(75 Peças de Arma e -2 Penalidade)`

- **Heroico**: *Pistola Semi-Automática (Revólver), Carabina de Tambor (Escopeta), Fuzil (Rifle), Canhão Enorme (Canhão Pesado), Lança-Granadas Pesado (Lança-Granadas Médio), Lança-Chamas Compacto (Lança-Chamas Simples)* `(100 Peças de Arma e -2 Penalidade)`

- **Lendário**: *Pistola Automática (Pistola Semi-Automática), Espingarda Automática (Carabina de Tambor), Rifle de Precisão (Fuzil), Bazuca Grompe (Canhão Enorme)* `(125 Peças de Arma e -4 Penalidade)`

- **Lendário**: *Pistola Rapinante (Pistola Automática), Escopeta Krug (Espingarda Automática), Fuzil Ancião (Rifle de Precisão), Bombarda Nashor (Bazuca Grompe)* `(150 Peças de Arma e -4 Penalidade)`
...
Cada 4 horas de criação de munição custam 5 Peças de Arma e geram uma quantidade de munição conforma a tabela de Criação de Munição. Quantidades menores podem ser feitas em tempo e valor diferente proporcional.                     
...
## Armeiro Adepto (Nível 2)
> [!attention]- *Requisitos: Estágio: Experiente, Armeiro Aprendiz*
...
_**20 natural**_. Obras-primas Gerais
...
## Armeiro Profissional (Nível 3) 
> [!attention]- *Requisitos: Estágio: Experiente, Armeiro Adepto*
...
_**20 natural**_. O valor de Força necessário não é modificado
...
## Armeiro Especialista (Nível 4)
> [!attention]- *Requisitos: Estágio: Experiente, Armeiro Profissional*
...
_Pré-requisito: Criar Baioneta I - Variável_
...
_**20 natural**_. Você preserva 25% da trama luminar que pode ser usada para outras criações.
...
_**20 natural**_. Você preserva 25% da trama sombria que pode ser usada para outras criações.
...
## Armeiro Mestre (Nível 5)
> [!attention]- *Requisitos: Estágio: Experiente, Armeiro Especialista*

### Modificação Elemental Maior

**Ofício**: Armeiro 5 + Encantador 4  
**Parte**: Cano  
**CD**: 20  
...
_Pré-requisito: Criar Arma de Fogo - Variável_
