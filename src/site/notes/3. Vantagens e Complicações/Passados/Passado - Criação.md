---
{"dg-publish":true,"permalink":"/3-vantagens-e-complicacoes/passados/passado-criacao/","tags":["passado","vantagem"],"dg-note-properties":{"tags":["passado","vantagem"]}}
---
...
Normalmente, Criações possuem uma peculiaridade ao serem criadas, caso você não tenha uma ideia de uma, você pode utilizar a tabela Peculiaridades da Criação para sortear uma **Peculiaridades da Criação**.

| Valor | Peculiaridades da Criação                                                                                                                            |
| :---: | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
|  d6   | Peculiaridade                                                                                                                                        |
...
**Perícias**: Uma perícias à sua escolha, normalmente ligado ao seu criador
...
Você é algo fora da curva, podendo ser um produto da ciência e uma afronta à natureza, ou mesmo um produto da natureza e uma afronta à ciência, como tal, certos seres percebem sua existência não natural. Graças a isso, sua mente acaba não cedendo da mesma forma que a de muitos, você possui **+2 de Bônus** em testes para resistir à Intimidação, seja por não entender as ameaças ou por não se importar com elas.