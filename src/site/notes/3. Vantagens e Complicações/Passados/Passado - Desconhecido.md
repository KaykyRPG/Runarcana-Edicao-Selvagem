---
{"dg-publish":true,"permalink":"/3-vantagens-e-complicacoes/passados/passado-desconhecido/","tags":["passado","vantagem"],"dg-note-properties":{"tags":["passado","vantagem"]}}
---
...
| Valor  | Pistas do Passado                         | Exemplos                                                                                                               |
| :----: | ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| **d6** | **Pista**                                 |                                                                                                                        |
...
**Perícias**: Seu teste de **Sem Perícia** não recebe penalidade, mas sim **+1 de bônus**.

**Idiomas**: Sempre que você conhecer a primeira vez um idioma novo, pode rolar **Sem Perícia**, caso tenha um acerto com aumento, role (d10) a tabela de Idiomas para saber sua **Proficiência no Idioma**. Em caso de falha, você pode rolar novamente sobre aquele idioma após um descanso completo. (Max. 5 Idiomas)

|  Valor  | Proficiência no Idioma                                                 |
| :-----: | ---------------------------------------------------------------------- |
| **d10** | **O que quanto você sabe sobre o idioma:**                             |
|   1-3   | Sabe-se ler, escrever e falar palavras e frases comuns.                |
|   4-6   | É possível manter uma conversa prolongada, mas pausada ocasionalmente. |
|   7-9   | Indica fluência no idioma.                                             |
|  10-12  | Permite imitar outros dialetos no idioma.                              |
|  13-15  | É possível recitar trabalhos literários ou orais com maestria.         |

**Equipamento**: Apenas uma muda de roupas que você está vestindo e 1 PO na sua bota.

### Vantagem: Memória Gradual
...
**Estágio Novato**: O PNJ, por acaso, reconhece você, mas não o conhece. Eles se lembram de você fazendo algum ato, como falar com uma figura misteriosa (e escutar algumas palavras), comprar um item de uma loja ou estar envolvido em uma briga.

Locais podem ser lugares que você visitou apenas uma vez ou que foram passados em seu caminho para outro lugar.

**Estágio Experiente**: O PNJ conhece você apenas por um nome de guerra e um pouco sobre o que aconteceu com você, mas é evasivo em lhe dar informações. Se forçados a falar, eles dão apenas uma pista antes que as circunstâncias terminem com o interrogatório (ele simplesmente escapa, ou está em uma posição de poder, ou uma tempestade violenta balança o barco).

Locais podem ser tavernas ou masmorras que você frequentou.

**Veterano**: O PNJ esteve diretamente envolvido com seu trauma e conhece sua verdadeira identidade. Algum conflito deve ser resolvido antes que seu relacionamento com você seja completamente entendido: Isso pode ser um encontro de combate ou um pedido feito por ele.
