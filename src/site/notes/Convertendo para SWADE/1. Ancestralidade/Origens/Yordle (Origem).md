---
{"dg-publish":true,"permalink":"/convertendo-para-swade/1-ancestralidade/origens/yordle-origem/","dgPassFrontmatter":true}
---


![Origem Yordle - Image.png](/img/user/z_Assets/Images/Origens/Origem%20Yordle%20-%20Image.png)
## Yordle
...
### Habilidade Raciais
Dependendo da Linhagem escolhida dentre os Berços, recebem habilidades raciais adicionais.

#### Habilidades Positivas: 
- **VISÃO NO ESCURO:** O ser ignora penalidades por Penumbra e Escuridão (mas não por Escuro como um Breu).
...
- **TAMANHO -2:** A entidade é menor que o normal, reduzindo seu Tamanho e Resistência em -2 (veja a [[Regras do SWADE/Tabela de Tamanho (SWADE)\|Tabela de Tamanho (SWADE)]]).
    
- **MOVIMENTAÇÃO REDUZIDA (1):** Reduza 1 quadro da Movimentação andando e seu dado de corrida em um tipo. Caso seu dado de corrida já seja um d4, ele é reduzido para d4 -1.
