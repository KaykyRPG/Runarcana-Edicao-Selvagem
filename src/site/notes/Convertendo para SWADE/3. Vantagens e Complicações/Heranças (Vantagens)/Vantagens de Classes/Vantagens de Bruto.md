---
{"dg-publish":true,"permalink":"/convertendo-para-swade/3-vantagens-e-complicacoes/herancas-vantagens/vantagens-de-classes/vantagens-de-bruto/","dgPassFrontmatter":true}
---
...
Seus ataques desarmados contam como **Armas Naturais** e passam a causar **Força+d4** *(em vez de somente Força)*.
...
### Entalhe Rúnico
> [!attention] *Pré-requisito: Estágio: Experiente, [[#Talhador de Runas I]]*
...
### Fúria Rúnica
> [!attention] *Pré-requisito: Estágio: Novato, [[#Talhador de Runas I]]*
...
Escolha **uma arma específica**. Você recebe **+2 em rolagens de Lutar ou Atirar** ao usá-la, seja em uma mão, duas mãos ou como arma de disparo (se aplicável).
...
Você aprende a inscrever runas no próprio corpo, pode aprende **2 Magias** da lista [[Convertendo para SWADE/5. Magias/Listas de Magias/Lista de Magias por Classe/Magias de Bruto\|Magias de Bruto]]. Quando utilizar magias das runas escritas em seu corpo, precisa fazer um teste de **Vigor com penalidade -1** para resistir a Fadiga causada.

### Talhador de Runas II
> [!attention] *Pré-requisito: ...*

Você aprende aprende **2 Magias** da lista [[Convertendo para SWADE/5. Magias/Listas de Magias/Lista de Magias por Classe/Magias de Bruto\|Magias de Bruto]]. O teste de Vigor agora é com **-2 de penalidade** para resistir a Fadiga causada.

### Talhador de Runas III
> [!attention] *Pré-requisito: ...*

Você aprende aprende **3 Magias** da lista [[Convertendo para SWADE/5. Magias/Listas de Magias/Lista de Magias por Classe/Magias de Bruto\|Magias de Bruto]]. O teste de Vigor agora é com **-3 de penalidade** para resistir a Fadiga causada.

### Talhador de Runas IV
> [!attention] *Pré-requisito: ...*

Você aprende aprende **4 Magias** da lista [[Convertendo para SWADE/5. Magias/Listas de Magias/Lista de Magias por Classe/Magias de Bruto\|Magias de Bruto]]. O teste de Vigor agora é com **-4 de penalidade** para resistir a Fadiga causada.

### Talhador de Runas V
> [!attention] *Pré-requisito: ...*

Você aprende aprende **5 Magias** da lista [[Convertendo para SWADE/5. Magias/Listas de Magias/Lista de Magias por Classe/Magias de Bruto\|Magias de Bruto]]. O teste de Vigor agora é com **-5 de penalidade** para resistir a Fadiga causada.
