---
{"dg-publish":true,"permalink":"/convertendo-para-swade/3-vantagens-e-complicacoes/herancas-vantagens/vantagens-de-classes/vantagens-de-cacador/","dgPassFrontmatter":true}
---
...
### Aceleração Rúnica
> [!attention] *Pré-requisito: Estágio: Experiente, [[#Disparo Rúnico I]]*

Após usar um Disparo Rúnico, você pode fazer um **ataque normal adicional** no mesmo turno.

### Adepto Rúnico
> [!attention] *Pré-requisito: Estágio: Experiente, [[#Arco Rúnico]]*
...
Você aprende a usar a essência mágica da natureza para para conjurar magias. Ganha **2 Magias (Poderes)** da lista de magias de Caçador.
...
> [!attention] *Pré-requisito: Estágio: Veterano, [[#Disparo Rúnico I]]*
...
### Disparo Rúnico I
> [!attention] *Pré-requisito: Estágio: Novato, Vantagem: [[#Arco Rúnico]]*

Você pode escolher um tipo de **Disparo Rúnico** (Veja a lista: Opções de Disparo Rúnico).

### Disparo Rúnico II
> [!attention] *Pré-requisito: Estágio: Experiente, Vantagem: [[#Arco Rúnico]]*

Você pode escolher um tipo de **Disparo Rúnico** (Veja a lista: Opções de Disparo Rúnico).

### Disparo Rúnico III
> [!attention] *Pré-requisito: Estágio: Veterano, Vantagem: [[#Arco Rúnico]]*

Você pode escolher um tipo de **Disparo Rúnico** (Veja a lista: Opções de Disparo Rúnico).

### Disparo Rúnico IV
> [!attention] *Pré-requisito: Estágio: Heroico, Vantagem: [[#Arco Rúnico]]*

Você pode escolher um tipo de **Disparo Rúnico** (Veja a lista: Opções de Disparo Rúnico).

### Disparo Rúnico V
> [!attention] *Pré-requisito: Estágio: Lendário, Vantagem: [[#Arco Rúnico]]*
...
### Égide Rúnica
> [!attention] *Pré-requisito: Estágio: Heroico, [[#Disparo Rúnico I]]*
...
### Impulso Rúnico
> [!attention] *Pré-requisito: Estágio: Veterano, [[#Arco Rúnico]]*
...
Você aprendeu como oponentes maiores lutam. Contra criaturas de **Tamanho +1 ou mais**, elas recebem **-1 em todo Ataque e Dano** realizado contra você.
...
Você dispara uma flecha envolta em energia vinculadora. Ao acertar um alvo, ele sofre dano normal e deve fazer uma rolagem resistida de **Força** contra sua **Aptidão Arcana**. Se falhar, fica **Preso**. Se falhar por 4+, fica **Imobilizado**. A condição dura até ele gastar uma ação para escapar *(Força ou Agilidade a -2)*.
...
A flecha estala com eletricidade. Ao acertar, causa **+2 de dano elétrico** e, se causar pelo menos um Ferimento, o alvo deve fazer um teste de **Vigor** ou fica **Atordoado**.
...
A flecha cria uma ponta rúnica superdensa. Recebe **+2 em Atirar e dano**. Contra alvos com Armadura natural alta (criaturas grandes), aumenta para **+4 em Atirar e Dano** no total.
